...
function deleteProvider(obj){
	$.ajax({
		...
		data:{method:"delprovider",proid:obj.attr("proid"),"aa":new Date().getTime()},
		dataType:"json",
...
$(function(){
	...
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/ProviderServlet?method=modify&proid="+ obj.attr("proid");
	});
